...
!function(n, t) {
    ...
    function(n) {
        ...
        for (var u, l = i(o.length), c = t(e) ? Object(new e(l)) : new Array(l), s = 0; s < l; )
            u = o[s],
    ...
    var fn = {
        ...
        j: function(n, t) {
            var e = this;
            return "object" !== sn(this.D[n]) && (this.D[n] = []),
            this.D[n].push(t),
            function() {
    ...
    function ot() {
        if (!tt().anchors.length) {
            ...
            n.length && n.length === p(tt().sectionSelector, Qn).length && (Xn = !0,
    ...
    function kt(n, t, e, i) {
        ...
        Mt = function(s) {
            ...
            if (vn.K) {
                ...
                f <= e && pt(n, v),
                f < e ? window.requestAnimationFrame(Mt) : void 0 === i || l || (i(),
                dn({
                    K: !1
                }),
                l = !0)
    ...
    function zt() {
        ...
        At.className = At.className.replace(o, ""),
        D(At, "fp-viewing-" + i)
    }
    function Ft(n) {
        if (!n)
    ...
    function qt(n, t, e) {
        ...
        j(W(t), An),
        Oe(),
        l.localIsResizing || (Pt(l.prevSlide),
        Ct(t)),
        function(n) {
            !tt().loopHorizontal && tt().controlArrows && (X(p(qn, n.section), 0 !== n.slideIndex),
            X(p(Yn, n.section), null != T(n.destiny)))
        }(l),
        a.isActive && !l.localIsResizing && Nt(l.slideIndex, l.slideAnchor, l.anchorLink),
        function(n, t, e) {
            var i, o, r = t.destinyPos;
            if (i = t.slidesNav,
            o = t.slideIndex,
            tt().slidesNavigation && null != i && (j(p(xn, i), An),
            D(p("a", p("li", i)[o]), An)),
            dn({
    ...
    function $t(n) {
        n.localIsResizing || (Y(tt().afterSlideLoad) && jt("afterSlideLoad", n),
        dn({
            G: !0
        }),
        Lt(n.destiny),
    ...
    function te() {
        ...
        for (var i = "", o = 0; o < hn().C.length; o++) {
            ...
            i += '<li><a href="#' + encodeURI(u) + '"><span class="fp-sr-only">' + It(a.index(), "Section") + "</span><span></span></a>";
    ...
    function ie(n, t) {
        ...
        tt().menu && tt().menu.length && p(tt().menu).forEach((function(n) {
            null != n && (j(p(xn, n), An),
            D(p('[data-menuanchor="' + e + '"]', n), An))
        }
        )),
        function(n, t) {
            var e = p(jn)[0];
            tt().navigation && null != e && "none" !== e.style.display && (j(p(xn, e), An),
    ...
    function ve(n, t, e) {
        ...
        if (null != i) {
            var o, r, a = function(n) {
                ...
                return t > w() ? (o || a) && "bottom" !== a || (i = r) : (o || vn.W && null == T(n)) && (i = r),
                dn({
                    nn: i
                }),
                i
            ...
            if (!(hn().F.item == i && !vn.W || tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
                ...
                tt().autoScrolling && tt().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function(n) {
                    ...
                    var t = hn().F.item;
                    return n.isMovementUp ? B(t, tn(t, En)) : N(t, en(t, En).reverse()),
                ...
                function(n) {
                    ...
                    tt().css3 && tt().autoScrolling && !tt().scrollBar)
                        ...
                        tt().scrollingSpeed ? (clearTimeout(le),
    ...
    function de(n) {
        ...
        function(n) {
            null != n.mn && (n.isMovementUp ? B(p(En)[0], n.mn) : N(p(En)[hn().C.length - 1], n.mn),
            St(hn().F.item.offsetTop),
            function() {
                for (var n = p(Pn), t = 0; t < n.length; t++)
                    Qt(n[t], "internal")
    ...
    function me(n) {
        ...
        O(p(jn)),
        D(At, yn),
        Y(tt().afterResponsive) && tt().afterResponsive.call(nt(), n)) : t && (Jt(et().autoScrolling, "internal"),
    ...
    fn.j("bindEvents", (function() {
        o.addEventListener("load", (function() {
            tt().scrollOverflow && !tt().scrollBar && (Me.Mn(),
            Me.bn())
        }
        ))
    }
    ...
    var Te, Me = {
        ...
        jn: function(n) {
            ...
            n.addEventListener("wheel", Me.kn, {
                passive: !1
            }),
        ...
        Pn: function(n, t) {
            ...
            var i = c ? 1 : 0
              ...
              , u = r || a;
            return u || (this.xn = (new Date).getTime()),
            u
        },
        Cn: function() {
        ...
        function(n) {
            ...
            Te = t,
            Y(tt().onScrollOverflow) && jt("onScrollOverflow", {
                position: t,
                direction: e
            }),
    ...
    je.prototype = at.prototype,
    je.prototype.constructor = je;
    var Le, Re = function(n, t) {
        this.parent = t,
        at.call(this, n, tt().slideSelector)
    };
    function Pe() {
        D(p(tt().sectionSelector, nt()), kn),
    ...
    function Ce(n) {
        ...
        t > 1 && (tt().controlArrows && function(n) {
            ...
            D(e[0], Gn),
            D(e[1], "fp-next"),
            "#fff" !== tt().controlArrowColor && (y(p(Yn, t), {
        ...
        tt().slidesNavigation && function(n) {
            ...
            for (var o = 0; o < e; o++)
                L(J('<li><a href="#"><span class="fp-sr-only">' + It(o, "Slide", p(Rn, t)[o]) + "</span><span></span></a></li>"), p("ul", i)[0]);
            y(i, {
    ...
    Re.prototype = at.prototype,
    Re.prototype.constructor = je;
    var ze = {
        attributes: !1,
        subtree: !0,
        childList: !0,
    ...
    function Ne(n) {
        var t = Fe();
        (Fe() || h(p(tt().sectionSelector, nt())).length !== hn().R) && !vn.en && (tt().observer && Le && Le.disconnect(),
        ke(),
        Oe(),
        tt().anchors = [],
        Z(p(jn)),
    ...
    fn.j("bindEvents", (function() {
        var n, t, e;
        tt().observer && "MutationObserver"in window && p(bn)[0] && (n = p(bn)[0],
        t = ze,
    ...
    var He, We, Ve, Ue, _e = (Ve = (new Date).getTime(),
    Ue = [],
    {
        Nn: function(n) {
    ...
    function Ke() {
        var n = tt().css3 ? H() + w() : rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight
          , t = ht(n);
        s.test.top = -n + "px",
        dn({
            G: !1
    ...
    function Je() {
        ...
        null != n ? ve(n, null, !1) : nt().scrollHeight < At.scrollHeight && fn.L("scrollBeyondFullpage")
    }
    function Ze() {
        var n = hn().F.prev();
    ...
    s.moveSectionDown = Je,
    s.moveSectionUp = Ze;
    var ni = 0;
    function ti(n) {
        tt().autoScrolling && (vn.G && (n.pageY < ni && _t().m.up ? Ze() : n.pageY > ni && _t().m.down && Je()),
        ni = n.pageY)
    }
    function ei(n) {
        if (_t().m[n]) {
    ...
    function mi(n) {
        ...
        l && hi(n) && tt().scrollBar && void 0 !== n.touches && (t.y = n.touches[0].pageY,
    ...
    function ki(n) {
        clearTimeout(oi);
        var t, e = n.keyCode, i = [37, 39].indexOf(e) > -1, o = tt().autoScrolling || tt().fitToSection || i;
        9 === e ? function(n) {
            var t = n.shiftKey
              , e = r.activeElement
              , i = Pi(vt(hn().F.item));
        ...
        }(n) : Q(t = r.activeElement, "textarea") || Q(t, "input") || Q(t, "select") || "true" == U(t, "contentEditable") || "" == U(t, "contentEditable") || !tt().keyboardScrolling || !o || (ii = n.ctrlKey,
    ...
    function Fi(n) {
        ...
        nt().addEventListener("mouseup", Ii)) : (r.addEventListener ? (G("mousewheel", Ni, !1),
        G("wheel", Ni, !1),
        G("MozMousePixelScroll", Ni, !1)) : r.detachEvent("onmousewheel", Ni),
    ...
    function Ni(n) {
        var t = (new Date).getTime()
          ...
          , i = function(n, t) {
            (new Date).getTime();
            var e = hn().B && n.getBoundingClientRect().bottom >= 0 && "up" === _e.In()
              , i = hn().Hn;
            if (i)
                return V(t),
                !1;
            if (hn().B) {
                if (e) {
                    ...
                    if (!(i || Xe("isNewKeyframe", "beyondFullpage") && _e.Bn()))
                        return (o = ht(rn(hn().C).item.offsetTop + rn(hn().C).item.offsetHeight)).element.scrollTo(0, o.options),
                        dn({
                            Hn: !1
                        }),
                        V(t),
    ...
    function Bi(n) {
        ...
        2 == n.which && (t = n.pageY,
        ni = t,
        nt().addEventListener("mousemove", ti))
    }
    function Ii(n) {
    ...
    function Hi(n) {
        ...
        function() {
            if (vi.Wn && (a || l)) {
                ...
                n.removeEventListener(vi.Wn, di, {
                    passive: !1
                }),
                n.addEventListener(vi.Vn, pi),
                n.addEventListener(vi.Wn, di, {
                    passive: !1
                })
            }
        }()) : (Fi(!1),
    ...
    function _i(n) {
        ...
        i != document && i ? ("touchend" === t && (Wi = !1,
        setTimeout((function() {
            Wi = !0
        }
        ), 800)),
        ("mouseenter" !== t || Wi) && (tt().normalScrollElements.split(",").forEach((function(n) {
            if (!e) {
                var t = Q(i, n)
                  , o = F(i, n);
                (t || o) && (s.shared.Gn || Hi(!1),
                s.shared.Gn = !0,
                e = !0)
            }
        }
    ...
    function Ji() {
        Qi || (tt().autoScrolling && !tt().scrollBar || !tt().fitToSection) && no(w()),
        function() {
            if (a)
                for (var n = 0; n < 4; n++)
        ...
        Gi = setTimeout((function() {
            !function() {
                ...
                no(""),
                tt().autoScrolling || vn.B || function() {
                    if (!tt().autoScrolling || tt().scrollBar) {
                ...
                a) {
                    ...
                    if (!Q(n, "textarea") && !Q(n, "input") && !Q(n, "select")) {
                        var t = w();
                        Math.abs(t - Yi) > 20 * Math.max(Yi, t) / 100 && (Zi(!0),
                        Yi = t)
                    }
                } else
                    e = w(),
    ...
    function Zi(n) {
        if (!m(nt(), Tn)) {
            ...
            Y(tt().afterResize) && n && tt().afterResize.call(nt(), o.innerWidth, o.innerHeight),
        ...
        !hn().B && !hn().Hn && (!tt().autoScrolling || tt().scrollBar))) {
            ...
            s)
                ...
                for (var v = 0; v < f.length; ++v)
                    f[v].item.offsetTop <= c && (l = v);
            else
                l = 0;
            if (i = u,
            o = hn().F.item.offsetTop,
            r = o + w(),
            ("up" == i ? r >= H() + w() : o <= H()) && (m(hn().F.item, On) || (D(hn().F.item, On),
            j(W(hn().F.item), On))),
            e = (t = f[l]).item,
            !t.isActive) {
                dn({
            ...
            tt().fitToSection && vn.G && (clearTimeout(lo),
    ...
    function vo(n) {
        ...
        tt().menu && tt().css3 && null != F(p(tt().menu)[0], bn) && p(tt().menu).forEach((function(n) {
            At.appendChild(n)
        }
        ))
    }
    function ho() {
        ...
        Lt(i),
        t = Ti((n = to()).section),
        n.section && t && (void 0 === t || t.index() !== A(ye)) || !Y(tt().afterLoad) || jt("afterLoad", {
            F: i,
            element: i,
            direction: null,
            anchorLink: e.anchor,
    ...
    function wo() {
        ...
        v("error", "https://github.com/alvarotrigo/fullPage.js#options")) : tt() && vn.Yn || r.domain.indexOf("alvarotrigo.com") > -1 ? n && n.length : (v("error", "Incorrect `licenseKey`. Get one for fullPage.js version 4 here:"),
        v("error", "https://alvarotrigo.com/fullPage/pricing")),
        m(xt, Mn) ? v("error", "Fullpage.js can only be initialized once and you are doing it multiple times!") : (tt().continuousVertical && (tt().loopTop || tt().loopBottom) && (tt().continuousVertical = !1,
    ...
    function bo(n, t) {
        ...
        !m(xt, Mn))
            ...
            s.test = Object.assign(s.test, {
                ...
                gn: function() {
                    for (var n = [], t = 0; t < p(tt().sectionSelector, nt()).length; t++)
    ...
    function() {
        fn.j("onInitialise", (function() {
            ...
            dn({
                ...
                u && (tt().credits && u && e <= u.Qn && u.Jn === t.split(n[0])[4] || function(n) {
                    var t = i[o()]().join("");
    ...
    s.destroy = function(n) {
        ...
        fn.L("onDestroy"),
        n && (St(0),
        p("img[data-src], source[data-src], audio[data-src], iframe[data-src]", nt()).forEach((function(n) {
            un(n, "src")
        }
        )),
